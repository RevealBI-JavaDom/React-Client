...
export default function Builder() {
  ...
  return (
    <>
      ...
      <aside className="fixed inset-y-0 left-0 hidden w-[480px] overflow-y-auto border-r border-gray-200 px-4 py-6 sm:px-6 lg:px-8 xl:block">
        <div>
          <ul
            role="list"
            className="divide-y divide-gray-100 overflow-y-auto max-h-[480px] bg-white shadow-sm ring-1 ring-gray-900/5 sm:rounded-xl"
          >
